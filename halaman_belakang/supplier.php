        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Table Seppller</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Seppler</li>
                    </ol>
                    <div class="card mb-4">
                        <div class="card-header">
                            <a href="tambah_sep/tambah_sep.php" class="btn btn-success"><i class="fas fa-table me-1"></i>
                                TAMBAH TABLE</a>
                        </div>
                        <div class="card-body">
